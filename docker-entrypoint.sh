...
ELASTICSEARCH_PING_TIMEOUT=${ELASTICSEARCH_PING_TIME_OUT:-1500}
ELASTICSEARCH_REQUEST_TIMEOUT=${ELASTICSEARCH_REQUEST_TIME_OUT:-30000}
ELASTICSEARCH_SHARD_TIMEOUT=${ELASTICSEARCH_SHARD_TIME_OUT:-0}
ELASTICSEARCH_STARTUP_TIMEOUT=${ELASTICSEARCH_STARTUP_TIME_OUT:-5000}
...
sed -i "s/ELASTICSEARCH_PING_TIMEOUT/${ELASTICSEARCH_PING_TIME_OUT}/g" /$KIBANA_CONF_DIR/kibana.yml
sed -i "s/ELASTICSEARCH_REQUEST_TIMEOUT/${ELASTICSEARCH_REQUEST_TIME_OUT}/g" /$KIBANA_CONF_DIR/kibana.yml
sed -i "s/ELASTICSEARCH_SHARD_TIMEOUT/${ELASTICSEARCH_SHARD_TIME_OUT}/g" /$KIBANA_CONF_DIR/kibana.yml
sed -i "s/ELASTICSEARCH_STARTUP_TIMEOUT/${ELASTICSEARCH_STARTUP_TIME_OUT}/g" /$KIBANA_CONF_DIR/kibana.yml
